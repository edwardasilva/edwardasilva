...
\titlespacing*{\section}{0pt}{0.60\baselineskip}{0.60\baselineskip}

% Consistent list spacing across document
\renewcommand\labelitemi{$\vcenter{\hbox{\small$\bullet$}}$}
\setlist[itemize]{leftmargin=12pt,topsep=4.0pt,itemsep=3.5pt,parsep=0pt,partopsep=0pt}
...
\textbf{MS Electrical Engineering} -- Controls and Signal Processing \hfill Expected May 2027 \\
\textbf{BS Electrical Engineering}, Minor in Computer Science \hfill Expected May 2026 \\
